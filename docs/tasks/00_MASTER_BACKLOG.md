...
| # | Milestone | Priority | Depends On | File |
|---|---|---|---|---|
| 4.1 | Orchestration schema (conversations, intents, hints, feedback) | P1 | 2.1 | `05_M4_ORCHESTRATION.md` |
| 4.2 | Intent API surface (parse/confirm/suggest/feedback) | P1 | 4.1 | `05_M4_ORCHESTRATION.md` |
